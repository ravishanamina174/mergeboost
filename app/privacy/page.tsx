...
export default function PrivacyPage() {
  return (
    <div className="space-y-6 rounded-3xl border border-white/10 bg-slate-900/70 p-8">
      <div>
        <p className="text-sm font-medium uppercase tracking-[0.3em] text-violet-400">Privacy & compliance</p>
        <h2 className="mt-2 text-2xl font-semibold text-white">Consent and policy controls</h2>
      </div>
