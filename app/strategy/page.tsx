...
export default function StrategyPage() {
  return (
    <div className="space-y-6 rounded-[2rem] border border-slate-200/80 bg-white p-8 shadow-sm">
      <div>
        <p className="text-sm font-medium uppercase tracking-[0.3em] text-slate-500">Strategy</p>
        <h2 className="mt-2 text-3xl font-semibold tracking-tight text-slate-900">Planning and messaging direction</h2>
      </div>
